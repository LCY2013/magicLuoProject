package com.lcydream.project.framework.context;
...
import com.lcydream.project.framework.utils.StringUtils;
...
public final class HandlerApplicationContext {
  ...
  public HandlerApplicationContext(String location) {
    ...
    try {
      ...
      // 注册，把所有的class找出来缓存
      String packageName = config.getProperty("scan.package");

 ...
 */
public class KafkasConsumerThree extends ShutdownableThread {
	...
	@Override
	public void doWork() {
		consumer.subscribe(Collections.singletonList(KafkasProperties.THREE_CONSUMER_TOPIC));
	...
	public static void main(String[] args) throws IOException {
		KafkasConsumerThree kafkasConsumer = new KafkasConsumerThree();

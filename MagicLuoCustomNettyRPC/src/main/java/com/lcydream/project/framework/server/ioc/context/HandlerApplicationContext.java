package com.lcydream.project.framework.server.ioc.context;

import com.lcydream.project.framework.server.ioc.annotation.CustomAwtowired;
import com.lcydream.project.framework.server.ioc.annotation.CustomComtroller;
import com.lcydream.project.framework.server.ioc.annotation.CustomService;
import com.lcydream.project.framework.server.ioc.utils.StringUtils;
...
public final class HandlerApplicationContext {
  ...
  public HandlerApplicationContext(String location) {
    ...
    try {
      ...
      // 注册，把所有的class找出来缓存
      String packageName = config.getProperty("server.scan.package");
